...
{
    public static class WMIManufacturers
    {
        public const string WMI_NOT_USED_COUNTRY = "не используется";
        public static readonly Dictionary<string, string> WMI_INDEXES = new Dictionary<string, string>()
        {
            {"AB", "ЮАР"},
            {"AA", "ЮАР"},
            {"AC", "ЮАР"},
